...
const API_CALL_ROOT_URL = `http://api.openweathermap.org/data/2.5/forecast?appid=${API_KEY}`
// above taken samples.openweathermap.org/data/2.5/forecast?q=London,us&mode=xml&appid=b1b15e88fa797225412429c1c50c122a1
// taken out:
...
export function findWeather(city) {
  const url = `${API_CALL_ROOT_URL}&q=${city},nl`;
